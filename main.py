...
choice = input("Press 1 for pomodoro timer, press 2 for a revising timetable , or press 3 for random study tips")
if choice == '1':
    ...
    print(random.choice(tips))
    print("To run the pomodoro timer again, please restart the program.")
